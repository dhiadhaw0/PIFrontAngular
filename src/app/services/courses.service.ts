...
export class CoursesService {
   ...
   */
  getCountByType(): Observable<Map<TypeFormation, number>> {
    return this.http.get<Map<TypeFormation, number>>(`${this.apiUrl}/stats/type`);
  }
  ...
  soumettreNote(id: number, note: number): Observable<string> {
    ...
    return this.http.post<string>(`${this.apiUrl}/${id}/note`, null, { params });
  }
